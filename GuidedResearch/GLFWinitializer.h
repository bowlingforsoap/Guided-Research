...
GLfloat lastFrame = 0.0f;  	// Time of last frame	
							...
							/*
							mouseCallback - activate/deactivate mouse callback
							*/
GLFWwindow* glfwInitialize(GLint width, GLint height, GLchar* windowName, GLint contextVersionMajor, GLint contextVersionMinor, bool mouseCallBack) {
	// Init GLFW
	glfwInit();
